<template>
  <div>
    ...
    >
      ...
      <template #navigation>
        <SfHeaderNavigationItem class="nav-item" v-e2e="'app-header-url_women'" label="WOMEN" :link="localePath('/c/categories/women')"/>
        <SfHeaderNavigationItem class="nav-item"  v-e2e="'app-header-url_men'" label="MEN" :link="localePath('/c/categories/men')" />
      </template>
      <template #aside>
...
import { useCart, useWishlist, useUser, cartGetters } from '@upsidelab/vue-storefront-spree';
